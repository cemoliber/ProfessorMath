...
class DivisionOperation : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //dialog box
        val dialog = Dialog(this@DivisionOperation)
        ...
        //initialize
        MobileAds.initialize(this@DivisionOperation) {
        ...
        //sound effects
        var correct = MediaPlayer.create(this@DivisionOperation,R.raw.correct2)
        var wrongSound = MediaPlayer.create(this@DivisionOperation,R.raw.incorrect)
        ...
        if(selectedValue.equals("Seviye 1")){
            //creates random numbers - we should try find the randomNum1 or randomNum2
            ...
            questionText.text = ""
            questionText.text = defaultAnswer.toString() + " / " + randomNum2.toString()
            ...
            controlAnswer.setOnClickListener{
                ...
                if(text == ""){
                    ...
                    if(gettedAnswer == randomNum1){
                        ...
                        clearGetAnswerBox()
                        newQuestions()
                    }else if(gettedAnswer != randomNum1){
                        ...
                        if(wrongCountL1 == 5){
                            ...
                            btnMenu.setOnClickListener {
                                ...
                                trueCountL1 = 0
                                wrongCountL1 = 0
                                val intent = Intent(this@DivisionOperation, Operations::class.java)
            ...
            val randomNum2 = Random.nextInt(1,30)
            val defaultAnswer = randomNum1 * randomNum2
            ...
            val randomNum1 = Random.nextInt(1,50)
            val randomNum2 = Random.nextInt(1,50)
            val defaultAnswer = randomNum1 * randomNum2
    ...
    private fun newQuestions() {
        ...
        val selectedValue = intent.getStringExtra("setSpinnerData")
        val correct = MediaPlayer.create(this@DivisionOperation,R.raw.correct2)
        val wrongSound = MediaPlayer.create(this@DivisionOperation,R.raw.incorrect)
